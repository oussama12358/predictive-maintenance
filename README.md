...
│                                                                         │
│  📊 SYSTEM STATISTICS                    🎯 RISK GAUGE        📈 TRENDS    │
│  ┌─────────────────────────┐            ┌─────────┐          ┌─────────┐   │
│  │ Total Predictions: 5    │            │ ███████ │ High   │    ██   │   │
│  │ High Risk: 2           │            │████████ │ Risk   │   ███   │   │
│  │ Medium Risk: 0         │            │█████████│ 95.6%  │  ████   │   │
│  │ Low Risk: 3            │            │████████ │        │ ██████  │   │
│  │ Avg Probability: 0.398 │            └─────────┘          └─────────┘   │
│  └─────────────────────────┘                                         │   │
│                                                                         │
│  🚨 RECENT PREDICTIONS                              ⚠️ HIGH RISK ALERTS │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │ Machine ID │ Risk Level │ Probability │ Recommendation             │   │
│  ├─────────────────────────────────────────────────────────────────────┤   │
│  │ MIL-002    │ High       │ 99.4%        │ Immediate inspection      │   │
│  │ MIL-004    │ High       │ 95.6%        │ Immediate inspection      │   │
│  │ MIL-001    │ Low        │ 0.01%        │ Normal monitoring         │   │
│  │ MIL-003    │ Low        │ 0.73%        │ Normal monitoring         │   │
│  │ MIL-005    │ Low        │ 0.90%        │ Normal monitoring         │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                         │
│  📊 RISK TREND ANALYSIS (Last 7 Days)                                   │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │ Day │ High │ Medium │ Low │ Total │                                │   │
│  │─────┼───────┼────────┼─────┼───────┤                                │   │
│  │ Mon │   1  │   0    │  2  │   3   │ ██████▌                        │   │
│  │ Tue │   2  │   1    │  1  │   4   │ ████████▎                       │   │
│  │ Wed │   0  │   0    │  3  │   3   │ ██████▌                        │   │
...
│                                                                           │
│  🔮 Predictive Maintenance API v1.0.0                                    │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │ 📡 ENDPOINTS                                                       │   │
...
│  │ {                                                                   │   │
│  │   "machine_id": "MIL-002",                                          │   │
│  │   "failure_probability": 0.9939,                                   │   │
│  │   "risk_level": "High",                                            │   │
│  │   "threshold_used": 0.7577,                                        │   │
│  │   "recommendation": "Schedule immediate inspection...",              │   │
│  │   "model_version": "xgb-v1.0",                                      │   │
│  │   "top_risk_factors": [                                              │   │
│  │     "rotational_speed_rpm: 1850.000 (importance: 0.204)",           │   │
│  │     "tool_wear_flag: 1.000 (importance: 0.135)",                   │   │
│  │     "tool_wear_min: 215.000 (importance: 0.100)"                    │   │
│  │   ]                                                                 │   │
│  │ }                                                                   │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                           │
│  ✅ TRY IT OUT  📋 DOWNLOAD  📖 SCHEMA  🔄 EXECUTE                         │
│                                                                           │
...
```
┌─ XGBOOST TRAINING PIPELINE OUTPUT ───────────────────────────────────────────┐
│                                                                           │
│  🚀 STARTING PREDICTIVE MAINTENANCE MODEL TRAINING                         │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │ [1/7] Loading data...                                               │   │
│  │ ✅ Data loaded: 10,000 rows x 13 columns                              │   │
│  │    Failure rate: 3.4% (339 failures)                                 │   │
│  │    Features: air_temp_c, process_temp_c, rotational_speed_rpm,       │   │
│  │             torque_nm, tool_wear_min, product_type                    │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                           │
│  🔧 [2/7] Feature engineering...                                          │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │ ✅ Created 8 engineered features                                    │   │
│  │    • wear_torque_interaction, speed_torque_index                     │   │
│  │    • temp_diff, power_consumption                                    │   │
│  │    • tool_wear_flag (binary), temp_torque_ratio                      │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                           │
│  📊 [3/7] Splitting data...                                               │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │ ✅ Train: 7,000 samples | Test: 3,000 samples                       │   │
│  │    Stratified split maintained failure rate                          │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                           │
│  ⚖️  [4/7] Applying SMOTE to training set...                              │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │ ✅ Balanced classes: 6,661 samples                                  │   │
│  │    Original: 6,661 (99%) / 339 (1%)                                 │   │
│  │    After SMOTE: 3,330 (50%) / 3,331 (50%)                           │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                           │
...
│  │    Fold 1: 0.9456 | Fold 2: 0.9321 | Fold 3: 0.9363                │   │
│  │    Fold 4: 0.9412 | Fold 5: 0.9348                                 │   │
...
│  │ ✅ Confusion Matrix:                                                 │   │
│  │    Predicted: [TP: 281, FP: 115]                                    │   │
│  │    Actual:    [FN: 51,  TN: 2553]                                    │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                           │
│  🎯 MODEL ARTIFACTS SAVED                                                │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │ • model.pkl (2.1 MB) - Trained XGBoost model                       │   │
│  │ • scaler.pkl (1.2 KB) - StandardScaler for features                 │   │
│  │ • threshold.json (45 B) - Optimal F2 threshold                      │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                           │
